...
const WELCOME: Message = {
  ...
  role: "assistant",
  content:
    "Hi! I'm N.A.V.I. - Nithya's Analytical Virtual Intelligence. Ask me anything about her background, projects, or skills! 👋",
};
...
export function NaviWidget() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessages((m) =>
        m.map((msg2) =>
          msg2.id === assistantId ? { ...msg2, content: msg } : msg2
        )
      );
    } finally {
      setIsLoading(false);
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: "0.65rem", color: "#7c2d6b", marginTop: 2 }}
            >
